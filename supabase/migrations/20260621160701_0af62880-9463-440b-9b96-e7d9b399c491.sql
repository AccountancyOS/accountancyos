-- ============================================================
-- Sprint 1 — Increment 1 / Task 5
-- Narrow flag-gated guard on lifecycle_approve_onboarding
-- ============================================================
-- Re-deploys lifecycle_approve_onboarding with ONLY a top-level guard added,
-- immediately after the existing rejected-status check. When the org's
-- canonical_lifecycle_enabled flag is ON, approval is blocked unless all
-- mandatory gates pass (via the shared lifecycle_onboarding_gates). When the
-- flag is OFF (default for every org), the guard is skipped and behaviour is
-- byte-identical to migration 20260603180743 — no live behaviour change.
-- The entire body below the guard is reproduced verbatim from 20260603180743.
-- ============================================================
