...
export function CompanyJobsTab({ companyId, organizationId }: CompanyJobsTabProps) {
        ...
        <CardHeader>
          <div className="flex items-center justify-between gap-4 flex-wrap">
            <div>
              ...
              <CardDescription>
                All work scheduled for this company. Jobs are generated automatically when a quote is accepted, based on the selected services and their statutory deadlines.
              </CardDescription>
            </div>
            <div className="flex gap-2">
              <Button variant="outline" size="sm" onClick={() => navigate(`/jobs?company=${companyId}`)}>
