...
import { EmailProviderStep } from "@/components/onboarding-wizard/EmailProviderStep";
...
const STEPS = [
  ...
  { id: 5, name: "Email Provider", description: "Connect your mailbox for client emails" },
